...
<script>
    ...
    import {modifyStaffByUserId,getUserRoles,queryRole,loadCompanyUserInfo,delUserCompany,addNewStaff,findUserByMobile,
    	requestUserCompany,batchAddUserRoles,complateUserCompany,processJoinApplication } from '@/api/getData'
...
//			},
            ...
            batchChangeStatus(status){
            	...
            	var params = [];
            	for(var i in this.staffTable){
            	    if(this.staffTable[i].id==null || this.staffTable[i].id=='') continue;
