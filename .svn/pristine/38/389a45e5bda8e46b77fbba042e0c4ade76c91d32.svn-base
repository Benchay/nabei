...
<script>
    ...
    import {queryStcok,queryWarehouseSeat,queryWarehouse,saveWarehouse,delWarehouseSeat,delWarehouse,saveWarehouseWithSeatNames} from '@/api/getData'
        ...
        methods: {
            ...
            async saveWarehouse(name) {
                ...
                if (res.isSuccess == true) {
                    ...
                    this.flushWarehouse(res.result,param.name,param.isStall,'add');
            ...
            async saveWarehouseWithSeatNames(name,seatObjs) {
            	//console.log(name);console.log(seatObjs);return;
                ...
                if (res.isSuccess == true) {
                    ...
                    this.flushWarehouse(res.result,param.name,param.isStall,'edit');
                }else{
                    this.$message({
                        type: 'error',
            ...
            //更新仓库选择
            flushWarehouse(warehouseId,warehouseName, isStall,type){
                let thisUserInfo = this.userInfo();
                if(type=='add'){
                    let warehouse= {id:warehouseId,name:warehouseName,isStall:isStall}
                   ...
                   // alert(JSON.stringify( getStore("userInfo")));
                    ...
                    thisUserInfo.warehouseList.splice(acc_index,1,warehouse)
