    ...
    <div class="fillcontain">
                ...
                <el-col :span="24" class="leftList leftList2">
                    ...
                    <el-col :span="19" class="content">
                        <div class="contentTips flex">
                            <el-col :span="24" class="content" v-show="codes.length > 0">
                                <el-tag
                                    :key="tag"
                                    size="small"
                                    v-for="tag in codes"
            ...
            <el-col :span="14" class="isRight">
                ...
                <el-table  id="tableData"
                    ...
                    <el-table-column
                        ...
                        label="数量">
                        <template scope="scope">
                            <el-input type="number" v-model="scope.row.orderNum" :min="1"></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="closeFee"
        ...
        <el-dialog
            ...
            <div style="text-align: center;padding: 30px 0;">
                <div style="margin-bottom: 20px">确定当前列表中的商品退货？</div>
                <div>
                    <el-checkbox v-model="checked">打印小票</el-checkbox>
                </div>
            </div>
            <span slot="footer" class="dialog-footer flex2">
                <a href="javascript:void(0)" class="buttonColor" @click="quickSalesReturnInfo">确 定</a>
...
<script>
    import {queryStalls,createHotProduct,queryBarcode,queryHotProduct,queryProduct,queryProductInfo,
    	queryStallCustomer,queryWarehouse,createOffLineFinanceRecord,createReturnOrSalesOrder} from '@/api/getData'
            ...
            async quickSalesReturnInfo(){
                ...
                for(let i = 0 ; i<this.tableData.length;i++){
                    let orderDetailVO ={
                        ...
                        "closeFee": this.tableData[i].closeFee * this.tableData[i].orderNum,
                        "orderType":4,
                    ...
                    let parameters = {
                        ...
                        orderNum:this.tableData[i].orderNum,
                        totalFee:this.tableData[i].closeFee,
                    };
