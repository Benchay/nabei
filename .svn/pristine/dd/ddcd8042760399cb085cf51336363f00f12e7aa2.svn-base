...
<script>
    ...
    import {createPaymentAccount, queryPaymentAccount,updatePaymentAccount,batchdeletePayment} from '@/api/getData'
    ...
    //        多选响应
            ...
            async batchDelete(array){
                ...
                const res = await batchdeletePayment(param);
    ...
    //        添加支付宝账户
            async configAlibabaAccountFormSubmit(formName){
            	this.$refs[formName].validate(async (valid) => {
					if (valid) {
                        const res = await createPaymentAccount(this.configAlibabaAccountform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
    ...
    //      添加微信账户
            async configWxAccountFormSubmit(formName){
            	this.$refs[formName].validate(async (valid) => {
					if (valid) {
                        const res = await createPaymentAccount(this.configWxAccountform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
    ...
    //      添加网银账户
            async configAccountCyberBankFormSubmit(formName){
            	this.$refs[formName].validate(async (valid) => {
					if (valid) {
                        const res = await createPaymentAccount(this.configAccountCyberBankform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
    ...
    //      添加及时到账账户
            async configAccountCurrentFormSubmit(formName){
            	this.$refs[formName].validate(async (valid) => {
					if (valid) {
                        const res = await createPaymentAccount(this.configAccountCurrentform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
    ...
    //      添加paypal账户
            async configAccountPaypalFormSubmit(formName){
            	this.$refs[formName].validate(async (valid) => {
					if (valid) {
                        const res = await createPaymentAccount(this.configAccountPaypalform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
          ...
          async submitFormEdit(formName){
                this.$refs[formName].validate(async (valid) => {
                    if (valid) {
                        const res = await updatePaymentAccount(this.editform);
                        if (res.isSuccess == true) {
                            this.$message({
                                type: 'success',
                                message: res.result.msg
