        ...
        <div class="papa">
                    ...
                    <div class="paydetailsBodyMain">
                      <div class="flex">
                        ...
                        <div class="flex" v-if="this.settlementOrder.status > 0">
                            <span>付款人:</span><span>{{this.settlementOrder.type==1?this.settlementOrder.updateUserName:this.settlementOrder.type==2?this.settlementOrder.createUserName:this.settlementOrder.type==11?this.settlementOrder.createUserName:this.settlementOrder.type==22?this.settlementOrder.updateUserName:''}}</span>
                        </div>
                        <div class="flex" v-if="this.settlementOrder.status > 0">
            ...
            <div class="stalllist">
                <div class="stalllistTitle">
                    <div><span>档口名称 : </span><span>{{this.settlementOrder.otherSideCompanyName}}</span>
...
<script>
       import {getSettlement,querySettlementDay,queryOrderBySettlementOrder,confirmSettlementOrder} from '@/api/getData'
    ...
    export default {
        ...
        methods: {
            ...
            changePage(id,type,otherOrderId){
                ...
                if(type==1||type==2){
                    this.$router.push({path:"/SettlementRecordsorderdetail" ,query:{backPath:"/SettlementRecordsdetail?otherSideCompanyId=" + this.otherSideCompanyId + "&settlementOrderId=" + this.settlementOrderId,id:orderId}});
                }else if(type==3||type==4){
                    this.$router.push({path:"/SettlementRecordsreturndetail" ,query:{backPath:"/SettlementRecordsdetail?otherSideCompanyId=" + this.otherSideCompanyId + "&settlementOrderId=" + this.settlementOrderId,orderId:orderId}});
                }
            },

            //立即付款
            quickPay(){
                this.$router.push({path:"/stallSettlementImmediately",query:{backPath:"/SettlementRecordsdetail?otherSideCompanyId=" + this.otherSideCompanyName+"&settlementOrderId="+this.settlementOrderId,saleCompanyId:this.otherSideCompanyId,settlementOrderId:this.settlementOrderId,type:this.settlementOrder.type}});
            },
