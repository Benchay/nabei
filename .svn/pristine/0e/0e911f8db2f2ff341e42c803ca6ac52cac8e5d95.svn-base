                ...
                <div class="orderDetails">
                    ...
                    <div  class="detailsCenter">
                        ...
                        <p>退货总金额：<span class="title">￥{{totalFee}}</span>
                            <el-button class="buttonColor3 jiesuan" v-if="(closeStutas==0 ||closeStutas ==2 )&& (status == 99|| status == 9) " :disabled="this.closingFee>0" @click="quickRecivePay">立即收款</el-button>
                        </p>
...
<script>
    ...
    import {queryOrderDetailByOrderId,queryOrderLog,sendRemind,cancelOrder} from '@/api/getData'
