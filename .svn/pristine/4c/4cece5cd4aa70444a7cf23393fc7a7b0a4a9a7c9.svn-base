                    ...
                    <el-tab-pane label="发起收款" name="first">
                        <div class="gathering">
                            ...
                            <el-col :span="12" class="flex">
                                ...
                                <el-col :span="18"  class="tkList">
                                    <el-input type="text" class="input1" v-model="reviceFee" placeholder="请输入" @change="CheckInputIntAndFloat" @blur="checkReviceFee" :disabled="isEdit"></el-input>
                                </el-col>
                            </el-col>
                            <el-col :span="12" class="flex">
                            ...
                            <el-row>
                                <el-col :span="24" class="flex">
                                    <el-col :span="3" class="listTitle">结算方式：</el-col>
                                    <el-col :span="18"  class="tkList ">
                                        <el-radio-group v-model="isOffLine" class="tkList2">
                                            <el-radio v-for="item in selectTions" :label="item.value">{{item.label}}</el-radio>
                                        </el-radio-group>
                                    </el-col>

                                </el-col>
                                <el-col :offset="3" :span="10" v-if="isOffLine===1">
                                    <p style="padding-left: 20px;padding-top: 10px;color:red;">{{"提醒：确认款项已结清"}}</p>
                                </el-col>
                            </el-row>
                            <el-col :span="24">
...
<script>
    ...
    import {isJson,getRoundNumbers} from  '../utils/common'
            ...
            '$route': function (route) {
                ...
                if(this.orderIds!=undefined&&this.orderIds.length!=0){
                    ...
                    if(this.unClosedFee!=undefined&&this.unClosedFee!=''){
                        this.unClosedFee = this.getRoundNumbers(this.unClosedFee);
                ...
                this.$nextTick(() => {
                    ...
                    if(this.reviceFee===0){
                        if(this.unClosedFee!=undefined&&this.unClosedFee>0){
                            this.reviceFee = this.getRoundNumbers(this.unClosedFee);
...
//                }
                ...
                if(this.reviceFee!=undefined){
                    this.reviceFee = this.getRoundNumbers(this.reviceFee);
                ...
                if(this.closeFee!=undefined){
                    this.closeFee = this.getRoundNumbers(this.closeFee);
                }
            },
