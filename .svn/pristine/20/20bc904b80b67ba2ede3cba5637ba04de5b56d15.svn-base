        ...
        <div class="indentManagement">
            ...
            <el-table
                ...
                <el-table-column
                    prop="totalFee"
                    label="订单金额">
                    <template scope="scope">{{getRoundNumbers(scope.row.totalFee)}}</template>
                </el-table-column>
                <el-table-column
                    prop="orderTime"
                    width="180"
                ...
                <el-table-column
                    label="操作">
                    <template scope="scope">
                        <a href="javascript:void(0);" class="color4" @click="queryDetailInfo(scope.row.id,scope.row.status)">
...
//            getRoundNumbers(val){
//                var result = Number(val).toFixed(3);
...
//            },
            ...
            queryDetailInfo(id,state){
                if(state == 5){
                    this.$router.push({path:'/indentManagementReturnDetails2',query:{orderId:id}});
