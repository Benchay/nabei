        ...
        <div class="financialManagement" :class="[identity ==1 ?'stallContent':identity ==2 ?'sellerContent':'']">
            <div class="AccountOverview">
                ...
                <div class="earlyWarning flex">
                    ...
                    <p>预警阈值为 <span>￥{{platformAccountVO.threshold==undefined||platformAccountVO.threshold==''?Number(100).toFixed(2):platformAccountVO.threshold}}</span></p>
            ...
            <el-dialog title="修改预警" :visible.sync="dialogFormVisible" size="tiny">
                <el-form :model="modifyform">
                    <el-form-item label="预警值：">
                        <el-input v-model="modifyform.val" onkeypress="return event.keyCode>=48&&event.keyCode<=57" auto-complete="off" style="width:110px;" size="small"></el-input><span style="margin-left: 5px">元</span>
                    </el-form-item>
                </el-form>
