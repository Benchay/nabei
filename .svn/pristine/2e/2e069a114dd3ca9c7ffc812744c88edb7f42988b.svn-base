    ...
    <div class="fillcontain">
        ...
        <el-dialog
            ...
            <div class="dialogZH" v-show="addBank">
                ...
                <el-col :span="24">
                    <el-col :span="7">户主真实姓名：</el-col>
                    <el-col :span="16"><el-input v-model="accountUserName" placeholder="请输入户主真是姓名" size="small" maxlength="30"></el-input></el-col>
                </el-col>
                <el-col :span="24">
                    <el-col :span="7">银行卡开户行：</el-col>
                    <el-col :span="16"><el-input v-model="accountBankName" placeholder="请输入银行卡开户行" size="small" maxlength="60"></el-input></el-col>
                </el-col>
            </div>
