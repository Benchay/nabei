            ...
            <div class="tablewrap" v-show="tableData3.length>0">
                <el-table
                    ...
                    <el-table-column
                        label="操作">
                        <template scope="scope">
                            <a @click="deledianpu(webstore)" class="blue2">删除</a>
                            <a @click="tongbu(webstore.id)" class="blue2" style="margin-left: 15px;">立即同步</a>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                items:[{
                    imgUrl:require("../image/bd_banner09.png")
                },
                {
                ...
                {
                    imgUrl:require("../image/bd_banner10.png")
                    }],
                options: [{
                value: '1',
                label: '淘宝'
