        ...
        <div class="papa">
                ...
                <div class="paydetailsBody">
                    ...
                    <div class="paydetailsBodyMain">
                        <!--<div class="flex" v-if="this.settlementOrder.status > 0">-->
                            <!--<span>实际付款金额:</span><span>{{this.settlementOrder.actualPayFee==undefined?0.00:getRoundNumbers(this.settlementOrder.actualPayFee)}}</span>-->
                        <!--</div>-->
                        <!--<div class="flex" v-if="this.settlementOrder.status > 0">-->
                        ...
                        <!--</div>-->
                        <!--<div class="flex" v-if="this.settlementOrder!=undefined&&this.settlementOrder.status > 0">-->
                        ...
                        <!--</div>-->
                        <!--<div class="flex" v-if="this.settlementOrder.type==1||this.settlementOrder.type==22">-->
                            <!--<span>抹平金额:</span><span>￥{{this.settlementOrder.fixFee==undefined?0.00:getRoundNumbers(this.settlementOrder.fixFee)}}</span>-->
                        <!--</div>-->
                        <!--<div class="flex" v-if="this.settlementOrder.type==1||this.settlementOrder.type==22">-->
                            <!--<span>实际收款金额:</span><span>￥{{this.settlementOrder.actualPayFee==undefined?0.00:getRoundNumbers(this.settlementOrder.actualPayFee)}}</span>-->
                        <!--</div>-->
                        <!--<div class="flex" v-if="this.settlementOrder.type==1||this.settlementOrder.type==22">-->
                      ...
                      <div class="flex">
                          <span>卖家名称:</span><span>{{this.busiName!=undefined&&this.busiName!=''?this.busiName:this.financeRecord!=undefined&&this.financeRecord.otherCompanyName!=undefined&&this.financeRecord.otherCompanyName!=''?this.financeRecord.otherCompanyName:''}}</span>
                      </div>
                      <div class="flex">
                      ...
                      <div class="flex">
                          <span>实际付款金额:</span><span>￥{{this.financeRecord.changeFee!=undefined?getRoundNumbers(this.financeRecord.changeFee):0.00}}</span>
                      </div>
                      <div class="flex">
            ...
            <div class="stalllist" v-show="this.settlementOrder!=undefined">
                <div class="stalllistTitle">
                    <div><span>卖家名称 : </span><span>{{this.busiName}}</span>
                      ...
                      <span style="font-size: 12px;">{{this.settlementDay}}</span></div>
                    <div><span>配货总金额(元) : </span><span>{{this.totalFee==undefined?0:getRoundNumbers(this.totalFee)}}</span></div>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <p>{{scope.row.totalFee==undefined?0:getRoundNumbers(scope.row.totalFee)}}</p>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="orderTime"
...
<script>
    import {querySettlementDay,queryOrderBySettlementOrder,getSettlement,getFinanceRecord} from '@/api/getData'
    ...
    export default {
        ...
        methods: {
            ...
            async loadData(){
                ...
                if(this.settlementOrderId==undefined||this.settlementOrderId==''){
                    ...
                    if(orderres.isSuccess){
                        ...
                        this.settlementFee = getRoundNumbers(realPayFee + realFixFee);
                        this.fixFee = getRoundNumbers(realFixFee);
            ...
            checkSettlementFee(){
                ...
                return getRoundNumbers(realPayFee + realFixFee);
            },
