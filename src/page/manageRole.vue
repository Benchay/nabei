...
<script>
    ...
    import {queryUserByCompany,saveRole,delRole,queryRole,queryAuthsByRole,batchAddUserRoles,queryUsersByRole,updateRole,getCompanyAuthsByCompanyId} from '@/api/getData'
...
//          },
            ...
            */
            ...
            async showAddMember(index){
                ...
                const res=await queryUserByCompany({"compId":this.roleForm.compId,"page":1,"pageSize":200,});
                if (res.isSuccess == true) {
