                ...
                <el-table id="tableData"
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <div class="flex4 tableFirst" style="padding: 3px;">
...
<script>
    ...
    import {queryStalls,createHotProduct,queryBarcode,queryHotProduct,queryProduct,queryProductInfo,queryStallCustomer,queryWarehouse
    	,createOffLineFinanceRecord,createReturnOrSalesOrder} from '@/api/getData'
