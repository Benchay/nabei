            ...
            <div>
                <div >
                    <div class="menuManagementTop">
                        <div class="left ">
                            <el-select v-model="applicationName" placeholder="请选择所属系统" @change="handleIconClick" size="small">
                                <el-option
                        ...
                        <div class="left flex2" style="margin-left: 20px;">
                            <el-input v-model="menuName" size="small" placeholder="请输入菜单名称" icon="search" :on-icon-click="handleIconClick" ></el-input>
                        </div>
                    </div>
                    <div class="right btn">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            let param = {"applicationId":'3',"pageIndex":this.currentPage,"pageSize":this.pageSize};//默认查询的是运营平台的菜单
            this.loadData(param);
        },
        methods: {
            ...
            handleIconClick(){
        	    ...
        	    if(this.menuName!=undefined&&this.menuName!=''){
        	        str = str + '"menuName":"' + this.menuName + '",'
                }
                str = str  +  '"applicationId":"' + this.applicationName + '","pageIndex":' + this.currentPage + ',"pageSize":' + this.pageSize + '}';
