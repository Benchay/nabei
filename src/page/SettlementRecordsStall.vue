                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <div class="flex stallOperation2">
                                <router-link :to='{path:"/sellerSettlementDetails",query:{settlementOrderId:scope.row.id}}'>查看详情</router-link>
                            </div>
                        </template>
                    </el-table-column>
                </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            handleIconClick(){
                ...
                if(this.checkNull(this.value)&&this.value!='-1'){
                    var sType = {name:"settlementType",value:this.value};
                    list.push(sType);
                }
                if(this.checkNull(this.balanceType)&&this.balanceType!='-1'){
