        ...
        <div class="sellerSettlement">
            ...
            <div class="details" >
                <el-col :span="24">
                    ...
                    <el-col :span="6">未结总欠款：{{unClosedFee==undefined?0:unClosedFee}}</el-col>
                    <el-col :span="18">
            ...
            <div class="detailsTable">
                <el-table
                    ...
                    <el-table-column
                        prop="closeFee"
                        label="已结金额">
                        <template scope="scope">{{getRoundNumbers(scope.row.closeFee)}}</template>
                    </el-table-column>
                    <el-table-column
                        label="未结金额">
                        <template scope="scope">
                           <p>{{getRoundNumbers(scope.row.totalFee*1-scope.row.closeFee*1)}}</p>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="hasExpireDays"
    ...
    export default {
        ...
        watch: {
            '$route': function (route) {
                ...
                this.unClosedFee = this.getRoundNumbers(this.unClosedFee*1);
                this.settlementOrderId = this.$route.query.settlementOrderId;
                this.toReviceFee  =  this.$route.query.toReviceFee;
                this.toReviceFee = this.getRoundNumbers(this.toReviceFee*1);
                ...
                this.undueFee = this.getRoundNumbers(this.unClosedFee*1- this.toReviceFee*1);
        ...
        mounted(){
            ...
            this.undueFee = this.getRoundNumbers(this.unClosedFee- this.toReviceFee);
            this.customName = this.$route.query.customName
            this.type = this.$route.query.type;
            if(this.type==undefined||this.type==''){
                this.type=2;
            ...
            quickSettlement(){
                ...
                this.multipleSelection.forEach((item) => {
                    if(item.closingFee!=undefined&&item.closingFee!=''&&item.closingFee>0){
                        ...
                        sumTotalFee = sumTotalFee*1 + Number(item.totalFee) - Number(closedFee) ;
                        closeFee = Number(closeFee) +  Number(closedFee);
                    }
                })
