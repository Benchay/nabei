        ...
        <div class="returns-content">
                    ...
                    <div class="flex detailsRight" >
                        <a href="javascript:void(0)" @click="salesDialog">
                            <div>
                                ...
                                <p>（{{status==7?'待签收':status==8?'待确认':status==9?'待入库':status==99?'已完成':''}}）</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <el-dialog
                ...
                <div class="flex3 affirmDialog">
                    ...
                    <p class="flex"> <el-checkbox v-model="bePutInStorage">确定退货商品立即入库吗？</el-checkbox></p>
                </div>
            ...
            <el-dialog
                ...
                <div class="dynamic">
                    ...
                    <el-col :span="12">{{status==7?'待签收':status==8?'待确认':status==9?'待入库':status==99?'已完成':''}}</el-col>
