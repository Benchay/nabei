                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <div class="tableFirst flex4" align="left">
...
<script>
    ...
    import {getCompanyStocks,createStockOrder,findSupplierList,loadProductInfo,queryProduct,checkImportProduct} from '@/api/getData'
