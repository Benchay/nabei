        ...
        <div class="purchasing-content">
            <div class="purchasingAll">
                ...
                <div class="orderForm">
                    ...
                    <el-col :span="8">{{changetype | formatChangetype(changetype)}}：{{createUserName}}</el-col>
                ...
                <div class="right"style="margin-top: 20px">
                    <div class="purPendingButton">
                        <a href="javascript:void(0)" class="buttonColor3" type="info" size="small" v-if="currPackageLogState == 21" @click="dialogStorage = true">入库</a>
            ...
            <el-col class="dynamicList2">
                <div class="track-rcol">
                    <div class="track-list">
                        <ul>
                            <li v-for="authitem in orderLog">
                                <i class="node-icon"></i>
                                <span class="time">{{authitem.createTime | mydateFormat}}</span>
                                <div class="txt">
                                    <span>{{authitem.changeType | formatChangeuser}}</span>
                                    <span>操作人：{{authitem.createUserName}}</span>
                                    <span>联系电话：{{authitem.mobile}}</span>
                                </div>
                            </li>
                            <!--
                            <li>
...
<script>
    ...
    import {queryPackageList,queryPackageLogInfo,loadPackage,updatePackgeStatus,getPackageFlowConfig} from '@/api/getData'
