...
<script>
    ...
    import {queryWorkMessage,getWorkMessageCount,readWorkMessage,delWorkMessage} from '@/api/getData'
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail(row){
	            ...
	            }else if(orderStatus && orderStatus == 'SELLER_CREATE_ORDER'){
            ...
            async initCount(){
            	...
            	const res = await getWorkMessageCount(params);
            	this.readCount = res.result;
            },
