                        ...
                        <el-row>
                            ...
                            <el-col :span="23">     
                                <div style="font-size:0px;">
                                    <span class="errortitle" v-if="errorShow">异常包裹:</span>
                    ...
                    <div class="goodscontent">
                       <div class="gooditem">
                            <div class="gooditemTop">
                                <div class="mdimgwrap">
                                    <img src="../image/packagec.png" alt="" v-if="creatpack">
                                </div>
                                <span class="describetion" :class="{'active':creatpack}">档口建包</span>
                                <span class="line" :class="{'active':creatpack}"></span>
                            </div>
                            <div class="gooditemBottom" v-if="creatpack">
                                <p><span>档口名称&nbsp;:</span><span>&nbsp;{{stallName}}</span></p>
                                <p><span>操作时间&nbsp;:</span><span>&nbsp;{{creatpacktime | formatDate}}</span></p>
                                <p><span>商品数量&nbsp;:</span><span>&nbsp;{{creatpacknum}}</span></p>
                            </div>
                        </div> 
                        <div class="gooditem">
                            <div class="gooditemTop">
            ...
            async initData(){
                ...
                if(res.isSuccess){
                    ...
                    res.result.packageLog.forEach((obj)=>{
                        if(obj.changeType == 0){
                            this.creatpack = true;
                            this.creatpacknum = obj.packedNum
                            this.creatpacktime = obj.createTime
                        }else if(obj.changeType == 1 && this.needTake1 == true){
                            this.needTake = true;
