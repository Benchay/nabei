        ...
        <div class="sellerSettlement">
            ...
            <div class="details" >
                <el-col :span="24">
                    ...
                    <el-col :span="6">当前总欠款：{{getRoundNumbers(totalFee)}}</el-col>
                    <el-col :span="18">
                    ...
                    <el-col :span="6">已到期：{{getRoundNumbers(expireFee)}}</el-col>
                    <el-col :span="18">未到期：{{getRoundNumbers(undueFee)}}</el-col>
                </el-col>
            </div>
            <div class="detailsTable" >
                ...
                <el-table
                    ...
                    <el-table-column
                        prop="actualPayFee"
                        label="结算金额">
                        <template scope="scope">{{getRoundNumbers(scope.row.actualPayFee)}}</template>
                    </el-table-column>
                    <el-table-column
                        prop="createTime"
                        label="结算时间"
