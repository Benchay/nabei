...
//预览函数		
export function  groupPrintPreview(group,width,height){
					if(!width){
						width = 600;
						height = 400;
					}
					...
					if(width==600){
						CreateAllPages_6040	(group);
					}else if(width==1000){
						CreateAllPages_10070(group);
					}else{
...
export function  groupPrint(group,width,height){
				var lodopResult = getLodop();
				if(lodopResult.code == 0){
					return lodopResult;
				}
...
export function CreateAllPages_6040(group){
		console.log(group);
		 group.forEach(({title,barCode,detail,dateTime,printNum,barText})=>{
					for(var i =0;i<printNum;i++){
					LODOP.NEWPAGE();
					...
					LODOP.PRINT_INIT("打印测试");
					LODOP.SET_PRINT_PAGESIZE(0,600,400,"0");
					LODOP.SET_PRINT_MODE("PRINT_SETUP_PROGRAM",true);
					LODOP.ADD_PRINT_TEXT(10,25,200,30,"公司A档口");
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_BARCODE(41,25,200,45,"Code39",barCode);
					LODOP.SET_PRINT_STYLEA(0,"ShowBarText",0);
					LODOP.ADD_PRINT_TEXT(95,15,200,45,barText);
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_TEXT(118,15,200,25,detail);
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_TEXT(136,25,200,25," -------由拿呗提供专业信息服务 Nabei.net-------");
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
...
export function CreateAllPages_10070(group){
		 group.forEach(({title,barCode,detail,dateTime,printNum,barText})=>{
					for(var i =0;i<printNum;i++){
					LODOP.NEWPAGE();
					LODOP.ADD_PRINT_TEXT(46,54,280,30,title);
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",16);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_BARCODE(77,54,300,50,"Code39",barCode);
					LODOP.SET_PRINT_STYLEA(0,"ShowBarText",0);
					LODOP.ADD_PRINT_TEXT(136,51,280,31,barText);
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
					LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_TEXT(165,51,280,28,detail);
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
					LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
					LODOP.ADD_PRINT_TEXT(202,51,280,30,"     --------由拿呗提供专业信息服务 Nabei--------");
					LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",8);
					LODOP.SET_PRINT_STYLEA(0,"FontColor","#808080");					
					}
